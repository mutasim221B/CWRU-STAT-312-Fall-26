...
## Example 1: Importing and getting to know the data 
...
a.  The code below creates a **boxplot** of this variable. In the comment, make note of how this code is similar to the code for the barplot above. 
