...
- Download additional Handout on [Boxplot](/handout/Boxplot-Example-Handout.pdf) (no need to print and bring it in the class though!)
...
Suppose we have collected the following random sample of $n=5$ observations:
...
\begin{aligned}
\bar{x}
&= \frac{\sum_{i=1}^{n}x_i}{n} \\[4pt]
&= \frac{3+7+10+11+14}{5} \\[4pt]
&= \frac{45}{5} \\[4pt]
&= 9.
\end{aligned}
$$
...
Using the deviations from the sample mean:
...
### Step 4: Verify using the convenient formula

The convenient formula for the sample variance is
...
-
\frac{\left(\displaystyle\sum_{i=1}^{n}x_i\right)^2}{n}
}{n-1}.
$$
...
Both methods give the same sample variance:
...
- We have now covered all the topics included in **Quiz 01**, which covers **Units 01 and 02**.

- Before attempting the quiz, carefully review the course material covered since the first day of class, including:

  - Class notes
  - Whiteboard notes
  - Handouts
  - Relevant textbook sections, especially if you missed a class

- Quiz 01 is designed to assess your general understanding of the course material covered so far.

- **Due:** Thursday, September 3, at 11:59 p.m. on Canvas.
